...
public abstract class BaseReporteBeneficiariosGeneral extends TestCase {
	
	@Autowired
	BeneficiariosServicio beneficiariosServicio;

	public Map getParams() {
        return params;
    }

    protected static final Log log = LogFactory.getLog(BaseReporteBeneficiariosGeneral.class);
