...
public class ControladorRestArchivo {
    ...
    public UploadArchivoResponse uploadFile(@RequestParam("file") MultipartFile file) {
    ...
    public List<UploadArchivoResponse> uploadMultipleFiles(@RequestParam("files") MultipartFile[] files) {
