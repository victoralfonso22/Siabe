...
public class DonativosDAO extends JdbcDaoSupport {
	...
	public List<Donativos> donativosPeriodoRFC(int idPeriodo) {	
		String sql = DonativosMapa.BASE_SQL + " where rfc in (select rfc from view_donativos where id_periodo = ?) ; ";
		Object[] params = new Object[] { idPeriodo };
		DonativosMapa mapper = new DonativosMapa();
		try {
			return this.getJdbcTemplate().query(sql, params, mapper);
	...
	public String insertaDonante(int idPeriodo, String razonSocial, String titulo, String nombre, String apellidoPaterno, String apellidoMaterno ,int estatus, String motivoEstatus, String adscripcion,  String tipoDonante, int idRegion, 
			...
			String numTarjeta,int mesVencimiento, int anioVencimiento, String tipoDonativo, int mesInicioAportacion, String email, String celular, String extension, String telefono1, String telefono2,String calle,
			String numE,String numI, String col, String loc, String mun, String edo, int cp, String razonFiscal, String calleFiscal, String numEFiscal, String numIFiscal, 
		...
		Object[] params = new Object[] { idPeriodo,  razonSocial.trim(), titulo.trim(),  nombre.trim(),  apellidoPaterno.trim(),  apellidoMaterno.trim() , estatus,  motivoEstatus,  adscripcion,   tipoDonante,  idRegion, 
				 ...
				 numTarjeta, mesVencimiento,  anioVencimiento,  tipoDonativo,  mesInicioAportacion,  email,  celular, extension, telefono1,  telefono2, calle,
				 numE,  numI,  col,  loc,  mun,  edo,  cp, razonFiscal, calleFiscal,  numEFiscal,  numIFiscal,  
	...
	public String insertaPatrocinador(int idPeriodo, String razonSocial, String titulo, String nombre, String apellidoPaterno, String apellidoMaterno, String adscripcion, int idRegion, int sector, 
			 String descripcionDonativo, String email, String extension,String celular, String telefono1, String telefono2, String calle,String numE, String numI, String col, String loc, String mun, 
			 String edo, int cp, String razonFiscal, String calleFiscal, String numEFiscal, String numIFiscal, String colFiscal, String locFiscal, String munFiscal, String edoFiscal, String cpFiscal,
		...
		Object[] params = new Object[] { idPeriodo,  razonSocial.trim(), titulo.trim(),  nombre.trim(),  apellidoPaterno.trim(),  apellidoMaterno.trim(),  adscripcion,  idRegion,  sector, descripcionDonativo,  
				email, extension, celular,  telefono1,  telefono2, calle, numE,  numI,  col,  loc,  mun, edo, 
				cp, razonFiscal, calleFiscal,  numEFiscal,  numIFiscal,  colFiscal,  locFiscal,  munFiscal,  edoFiscal,  cpFiscal, rfc.toUpperCase(), 
	...
	public String actualizaDatosDonantes( String razonSocial, String titulo, String nombre, String apellidoPaterno, String apellidoMaterno ,int estatus, String motivoEstatus, String adscripcion,  String tipoDonante, int idRegion, 
			int sector, int idCampania, int medioAutorizacionDonativo, String observacionesMedioAutorizacion, int medioCobro, String numPersonal, String dependenciaAdscripcion, double donativoTotal, double donativoQuincenal,
			int numQuincenas, int idQuincenaInicio, String anioQuincena, int idCuentasBancarias, String referencia, int numPagos, double importeNumPagos, String banco, String nombreTarjetahabiente, String red, String tipoTarjeta,
			String numTarjeta,int mesVencimiento, int anioVencimiento, String tipoDonativo, int mesInicioAportacion, String email, String celular, String extension,String telefono1, String telefono2,String calle,String numE, 
			String numI, String col, String loc, String mun, String edo, int cp, String calleFiscal, String razonFiscal,String numEFiscal, String numIFiscal, String colFiscal, 
		...
		String sql = DonativosMapa.UPDATE_SQL + " razon_social = ?, titulo = ?, nombres = ?, apellido_paterno = ?,apellido_materno = ?,estatus = ?,motivo_estatus = ?," + 
				...
				"			mes_inicio_aportacion = ?,email = ?,celular = ?, extension=?, telefono1 = ?,telefono2 = ?,calle = ?,num_exterior = ?,num_interior = ?,colonia = ?, localidad = ?, municipio = ?, estado = ?, cp = ?, razon_social_fiscal = ?," + 
		...
		Object[] params = new Object[] {  razonSocial.trim(), titulo.trim(),  nombre.trim(),  apellidoPaterno.trim(),  apellidoMaterno.trim() , estatus,  motivoEstatus,  adscripcion,   tipoDonante,  idRegion, 
				 ...
				 mesVencimiento,  anioVencimiento,  tipoDonativo,  mesInicioAportacion,  email,  celular, extension,  telefono1,  telefono2,
				 calle,numE,  numI,  col,  loc,  mun,  edo,  cp, razonFiscal, calleFiscal,  numEFiscal,  numIFiscal,  colFiscal,  locFiscal,  munFiscal,  edoFiscal,  cpFiscal,
	...
	public String actualizaDatosPatrocinadores( String razonSocial, String titulo, String nombre, String apellidoPaterno, String apellidoMaterno, String adscripcion, int idRegion, int sector, 
			 String descripcionDonativo, String email, String celular, String extension, String telefono1, String telefono2,String calle,String numE, String numI, String col, String loc, String mun, 
			 String edo, int cp, String razonFiscal, String calleFiscal, String numEFiscal, String numIFiscal, String colFiscal, String locFiscal, String munFiscal, String edoFiscal, String cpFiscal,
		...
		String sql = DonativosMapa.UPDATE_SQL + " razon_social = ?, titulo = ?, nombres = ?, apellido_paterno = ?,apellido_materno = ?," + 
				"	adscripcion = ?, id_region = ?, sector = ?, descripcion_donativo = ?, email = ?,celular = ?, extension=?, telefono1 = ?,telefono2 = ?,calle = ?,num_exterior = ?,num_interior = ?,colonia = ?, localidad = ?, municipio = ?, estado = ?, cp = ?, razon_social_fiscal = ?," + 
				"	calle_fiscal = ?,num_exterior_fiscal = ?,num_interior_fiscal = ?,colonia_fiscal = ?, localidad_fiscal = ?, municipio_fiscal = ?, estado_fiscal = ?, cp_fiscal = ?, rfc=?," + 
				"	observaciones = ? where id =?;";
		...
		Object[] params = new Object[] {  razonSocial.trim(), titulo.trim(),  nombre.trim(),  apellidoPaterno.trim(),  apellidoMaterno.trim(),  adscripcion,  idRegion,  sector, 
				  descripcionDonativo,  email,  celular, extension, telefono1,  telefono2, calle, numE,  numI,  col,  loc,  mun, 
				  edo,  cp, razonFiscal, calleFiscal,  numEFiscal,  numIFiscal,  colFiscal,  locFiscal,  munFiscal,  edoFiscal,  cpFiscal,
				  rfc,  observaciones,  idDonativo};
		// System.out.println(sql+ id+ password);
	...
	public List<Donativos> autocompletarDonativosTipoDonativo(int tipoDonativo, String termino, int idPeriodo) {
		...
		sql = DonativosMapa.BASE_SQL + " vd\r\n" + 
			...
			sql = DonativosMapa.BASE_SQL + " where nombre_completo_don like '%"+termino+"%' and id_periodo = "+idPeriodo+";"; 
		}
		//System.out.println(sql);
...
//		System.out.println(sql);
	...
	public boolean refrendaDonativos(int idDonante, int idPeriodo, int idUsuario) {
		
		String sql = DonativosMapa.procedureRefrendo + " ("+idDonante+","+idPeriodo+","+idUsuario+")";
